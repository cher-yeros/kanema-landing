# Canma Landing — System Documentation

## Purpose

`canma-landing` is a **Next.js (App Router)** web app that combines:

- **Marketing landing site**: Canma brand + sections (Hero, About, Services, Team, Contact).
...
**Team/Leadership** describes Canma’s public-facing organization and governance model. It matters for trust (especially for elections) and partner engagement.
...
- Token is stored in `localStorage` under key **`canma_token`**
